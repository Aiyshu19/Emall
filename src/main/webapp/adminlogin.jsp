...
<%
if(session.getAttribute("adminlogin")!=null) //check login session user not access or back to index.jsp page
{
...
try
{
	...
	if(request.getParameter("btn_login")!=null) //check login button click event not null
	{
		...
		pstmt=con.prepareStatement("select * from adminlogin where email=? AND password=?"); //sql select query 
		...
		if(rs.next())
		{
			...
			{
				session.setAttribute("adminlogin",dbemail); //session name is login and store fetchable database email address
				response.sendRedirect("admindash.jsp"); //after login success redirect to welcome.jsp page
			}
		}
		else
		{
    ...
    <div class="main-content">
        ...
        <form class="form-register" method="post" name="myform" onsubmit="return validate();">
            ...
            <div class="form-register-with-email">
				...
				<a href="adminregister.jsp" class="form-log-in-with-existing">You Don't have an account? <b> Register here </b></a>
