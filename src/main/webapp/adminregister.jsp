...
<%
if(session.getAttribute("adminlogin")!=null) //check login session user not access or back to adminregister.jsp page
{
...
try
{
	...
	if(request.getParameter("btn_register")!=null) //check register button click event not null
	{
		...
		pstmt=con.prepareStatement("insert into adminlogin(firstname,lastname,email,password) values(?,?,?,?)"); //sql insert query
